...
func (t *StorageMinerActorState) MarshalCBOR(w io.Writer) error {
	...
	// t.PreCommittedSectors (map[string]*strgminr.PreCommittedSector) (map)
	{
	...
	// t.NextDoneSet (types.BitField) (struct)
	...
	// t.ProvingPeriodEnd (uint64) (uint64)
...
func (t *PreCommittedSector) MarshalCBOR(w io.Writer) error {
	...
	// t.Info (strgminr.SectorPreCommitInfo) (struct)
